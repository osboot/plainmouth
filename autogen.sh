...
register aclocal    "${ACLOCAL:-aclocal}"       '' '' $OPT -I config/m4
register autoconf   "${AUTOCONF:-autoconf}"     '' '' $OPT -I config/m4
register autoheader "${AUTOHEADER:-autoheader}" '' '' $OPT -I config/m4
