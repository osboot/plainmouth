...
./plainmouth plugin=password action=create id=w1 x=1 y=1 width=40 height=5 \
	text="(1) Enter password:
123456789 123456789 123456789" \
	label="qwerty asdfghjk: "

./plainmouth plugin=password action=create id=w2 x=20 y=4 width=30 height=4 text="(2) Enter password:"
