...
static void curses_init(void)
{
	...
	if (has_colors()) {
		...
		init_pair(COLOR_PAIR_EXTRA1, COLOR_BLACK, COLOR_RED);
		init_pair(COLOR_PAIR_EXTRA2, COLOR_BLACK, COLOR_GREEN);
		init_pair(COLOR_PAIR_EXTRA3, COLOR_BLACK, COLOR_YELLOW);
		init_pair(COLOR_PAIR_EXTRA3, COLOR_BLACK, COLOR_CYAN);
